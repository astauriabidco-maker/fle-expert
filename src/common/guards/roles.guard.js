...
var RolesGuard = function () {
    ...
    var RolesGuard = _classThis = /** @class */ (function () {
        ...
        RolesGuard_1.prototype.canActivate = function (context) {
            ...
            // Assuming user is attached to request by AuthGuard (which we haven't implemented yet, but this is standard)
            // For this task, we assume user object exists with a role.
            if (!user) {
                return false;
            }

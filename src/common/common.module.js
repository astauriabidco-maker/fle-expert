...
var CommonModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            providers: [security_service_1.SecurityService, tenant_interceptor_1.TenantInterceptor, roles_guard_1.RolesGuard, context_service_1.ContextService],
            exports: [security_service_1.SecurityService, tenant_interceptor_1.TenantInterceptor, roles_guard_1.RolesGuard, context_service_1.ContextService],
        })];

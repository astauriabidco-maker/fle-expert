...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        function PrismaService_1(contextService) {
            var _this = this;
            var connectionString = process.env.DATABASE_URL;
            var pool = new pg_1.Pool({ connectionString: connectionString });
            var adapter = new adapter_pg_1.PrismaPg(pool);
            _this = _super.call(this, { adapter: adapter }) || this;
        ...
        Object.defineProperty(PrismaService_1.prototype, "extended", {
            get: function () {
                        ...
                        $allModels: {
                            $allOperations: function (_a) {
                                return __awaiter(this, arguments, void 0, function (_b) {
                                    var organizationId, anyArgs, anyArgs;
                                    var model = _b.model, operation = _b.operation, args = _b.args, query = _b.query;
                                    return __generator(this, function (_c) {
                                        organizationId = contextService.get('organizationId');
                                        if (organizationId) {
                                            if (operation === 'findUnique' ||
                                                ...
                                                if (['User', 'ExamSession', 'CreditTransaction', 'Question'].includes(model)) {
